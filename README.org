...
this. Perhaps a theme randomizer upon booting Emacs would be nice.
...
#+BEGIN_SRC shell
  if [ -z "$__BAUER_ADD_PATHS" ]; then
    ...
    export INFOPATH=$HOME/.nix-profile/share/info:@INFOPATH@${INFOPATH:+:$INFOPATH}
    export MANPATH=:$HOME/.nix-profile/share/man:@MANPATH@${MANPATH:+:$MANPATH}
    export XDG_DATA_DIRS=$HOME/.nix-profile/share:@XDG_DATA_DIRS@${XDG_DATA_DIRS:+:$XDG_DATA_DIRS}
    export TERMINFO_DIRS=@TERMINFO_DIRS@${TERMINFO_DIRS:+:$TERMINFO_DIRS}
  fi
  ...
  export PS1='\e[34m\u@\h:\e[36m\w \e[33m\$\e[0m '
#+END_SRC
